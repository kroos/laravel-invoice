	...
	*/
	public function run()
	{
		...
		DB::table('products')->insert([
			...
			'slug' => 'Miracle Body Lotion Sample',
			'id_category' => 3,
			'retail' => 8,
			'commission' => 0.5,
			'active' => 1,
		...
		DB::table('products')->insert([
			...
			'slug' => 'Bedak Panas (Param, Pilis & Lulur)',
			'id_category' => 3,
			'retail' => 35,
			'commission' => 0.5,
			'active' => 1,
		...
		DB::table('products')->insert([
			...
			'slug' => 'Homemade Miracle Oil (Small)',
			'id_category' => 3,
			'retail' => 29,
			'commission' => 0,
			'active' => 1,
		...
		DB::table('products')->insert([
			...
			'slug' => 'Homemade Miracle Oil (Large)',
			'id_category' => 3,
			'retail' => 49,
			'commission' => 1,
			'active' => 1,
		...
		DB::table('products')->insert([
			...
			'slug' => 'Seluar Mengandung (Prelove)',
			'id_category' => 1,
			'retail' => 50,
			'commission' => 1,
			'active' => 1,
