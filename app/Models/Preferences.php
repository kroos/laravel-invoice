...
class Preferences extends Model
{
	...
	{
		$this->attributes['company_address'] = Str::title(Str::lower($value));
	}
	...
	{
		$this->attributes['company_tagline'] = Str::title(Str::lower($value));
	}
	...
	{
		return $this->BelongsTo(\App\Models\User::class, 'company_owner');
	}

	public function compInCharge(): BelongsTo
	{
		return $this->BelongsTo(\App\Models\User::class, 'company_person_in_charge');
	}
}
