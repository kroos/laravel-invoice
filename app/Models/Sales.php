...
#####################################################################################
	...
	{
		return $this->hasOne(\App\Models\SlipPostage::class, 'id_sales');
	}

	public function customer(): HasOne
	{
		return $this->hasOne(\App\Models\SalesCustomers::class, 'id_sales');
	}

	public function invitems(): HasMany
	{
		return $this->hasMany(\App\Models\SalesItems::class, 'id_sales');
	}

	public function slipnumber(): HasMany
	{
		return $this->hasMany(\App\Models\SlipNumbers::class, 'id_sales');
	}

	public function salestaxes(): HasMany
	{
		return $this->hasMany(\App\Models\SalesTax::class, 'id_sales');
	}

	public function salespayment(): HasMany
	{
		return $this->hasMany(\App\Models\Payments::class, 'id_sales');
	}
