	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="col-lg-12">
				...
				<?php echo Form::model($sales, ['route' => ['sales.update', $sales->id], 'method' => 'PATCH', 'class' => 'form-horizontal', 'autocomplete' => 'off', 'files' => true]); ?>
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group <?php echo ( count($errors->get('date')) ) >0 ? 'has-error' : ''; ?>">
...
?>
								<div class="form-group <?php echo ( count($errors->get('serial.*.tracking_number')) ) > 0 ? 'has-error' : '' ?> rowserial">
									<a href="<?php echo route('slipnumbers.destroy', $e->id); ?>" class="btn btn-danger col-lg-1">-</a><?php echo Form::label('catel', 'Receipt or Postage Tracking :', ['class' => 'col-sm-4 control-label']); ?>

									<input type="hidden" name="serial[<?php echo $vs; ?>][id]" value="<?php echo $e->id; ?>">
									<div class="col-sm-7">
										<?php echo Form::input('text', 'serial['.$vs.'][tracking_number]', $e->tracking_number, ['class' => 'form-control', 'placeholder' => 'Receipt or Tracking Serial Number', 'id' => 'catel']); ?>
...
?>
							<div class="form-group <?php echo ( count($errors->get('client')) ) >0 ? 'has-error' : ''; ?>">
								...
								<div class="col-sm-9">
									<?php echo Form::input('text', 'client', $cst->client, ['class' => 'form-control', 'placeholder' => 'Customer Name', 'id' => 'pel']); ?>
							...
							<div class="form-group <?php echo ( count($errors->get('client_address')) ) >0 ? 'has-error' : ''; ?>">
								...
								<div class="col-sm-9">
									<?php echo Form::textarea('client_address', $cst->client_address, ['class' => 'form-control', 'placeholder' => 'Customer Address', 'id' => 'apel']); ?>
							...
							<div class="form-group <?php echo ( count($errors->get('client_poskod')) ) >0 ? 'has-error' : ''; ?>">
								...
								<div class="col-sm-9">
									<?php echo Form::input('text', 'client_poskod', $cst->client_poskod, ['class' => 'form-control', 'placeholder' => 'Postcode', 'id' => 'pos']); ?>
							...
							<div class="form-group <?php echo ( count($errors->get('client_phone')) ) >0 ? 'has-error' : ''; ?>">
								...
								<div class="col-sm-9">
									<?php echo Form::input('text', 'client_phone', $cst->client_phone, ['class' => 'form-control', 'placeholder' => 'Phone', 'id' => 'tel']); ?>
							...
							<div class="form-group <?php echo ( count($errors->get('client_email')) ) >0 ? 'has-error' : ''; ?>">
								...
								<div class="col-sm-9">
									<?php echo Form::input('text', 'client_email', $cst->client_email, ['class' => 'form-control', 'placeholder' => 'Email', 'id' => 'tela']); ?>
...
<div class="row rowinvoice">
	<div class="col-sm-12">
		<div class="col-sm-1">
			<div class="row">
				<div class="col-sm-12">
					<a href="<?php echo route('salesitems.destroy', $e->id); ?>" class="btn btn-danger" type="button">-</a>
					<input type="hidden" name="inv[<?php echo $v; ?>][id]" value="<?php echo $e->id; ?>">
				</div>
			</div>
		</div>
		<div class="col-sm-4">
			<div class="row">
				<div class="col-sm-12 form-group <?php echo ( count($errors->get('inv.*.id_product')) ) >0 ? 'has-error' : '' ?>">
					<select name="inv[<?php echo $v; ?>][id_product]" class="series form-control">
						...
						<?php $__currentLoopData = $cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<optgroup label="<?php echo $key->product_category; ?>">
								...
								<?php $__currentLoopData = $pro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo $r->id; ?>" data-commission="<?php echo $r->commission; ?>" data-retail="<?php echo $r->retail; ?>" <?php echo ($r->id == $e->id_product)? 'selected="selected"' : ''; ?>><?php echo $r->product; ?></option>
		...
		<div class="col-sm-2">
			<div class="row">
				<div class="col-sm-12 form-group <?php echo ( count($errors->get('inv.*.commission')) ) >0 ? 'has-error' : ''; ?>">
					<input <?=(auth()->user()->id_group == 1)? 'type="text"' : 'type="hidden"' ?> name="inv[<?php echo $v; ?>][commission]" class="comm form-control" value="<?php echo $e->commission; ?>" placeholder="Commission (RM)" />
				</div>
			</div>
		</div>
		<div class="col-sm-2">
			<div class="row">
				<div class="col-sm-12 form-group <?php echo ( count($errors->get('inv.*.retail')) ) >0 ? 'has-error' : ''; ?>">
					<input type="text" name="inv[<?php echo $v; ?>][retail]" class="rate form-control" value="<?php echo $e->retail; ?>" placeholder="Retail (RM)"/>
				</div>
			</div>
		</div>
		<div class="col-sm-2">
			<div class="row">
				<div class="col-sm-12 form-group <?php echo ( count($errors->get('inv.*.quantity')) ) >0 ? 'has-error' : ''; ?>">
					<input type="text" name="inv[<?php echo $v; ?>][quantity]" class="quan form-control" value="<?php echo $e->quantity; ?>" placeholder="Quantity" />
				</div>
			</div>
		</div>
		<div class="col-sm-1">
			<div class="row">
				<div class="col-sm-12">
					<p class="text-right"><span class="total_price"><?php echo $e->retail * $e->quantity; ?></span></p><?php $y += $e->retail * $e->quantity ?>
				</div>
			</div>
		</div>
	</div>
...
?>
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<div class="col-xs-4 text-right">
													<p><strong id="total_tax"><?php echo $tcharge; ?></strong>%</p>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<div class="col-xs-4 text-right">
													<p>RM<strong id="total_amount"><?php echo $y; ?></strong></p>
												</div>
											</div>
										</div>
...
<div class="row rowpayment">
	<div class="col-sm-12">
		<div class="col-sm-1">
			<div class="row">
				<div class="col-sm-12">
					<a href="<?php echo route('payments.destroy', $o->id); ?>" class="btn btn-danger" type="button">-</a>
					<input type="hidden" name="pay[<?php echo $z; ?>][id]" value="<?php echo $o->id; ?>">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="row">
				<div class="col-sm-12 form-group <?php echo ( count($errors->get('pay.*.id_bank')) ) >0 ? 'has-error' : '' ?>">
					<select name="pay[<?php echo $z; ?>][id_bank]" class="form-control">
						...
						<option value="<?php echo $r->id; ?>" <?php echo ($r->id == $o->id_bank)? 'selected="selected"' : ''; ?>><?php echo $r->bank; ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
				</div>
			</div>
		...
		<div class="col-sm-2">
			<div class="row">
				<div class="col-sm-12 form-group <?php echo ( count($errors->get('pay.*.date_payment')) ) >0 ? 'has-error' : ''; ?>">
					<input type="text" name="pay[<?php echo $z; ?>][date_payment]" value="<?php echo $o->date_payment; ?>" class="form-control date" placeholder="Date Payment"/>
				</div>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="row">
				<div class="col-sm-12 form-group <?php echo ( count($errors->get('pay.*.amount')) ) >0 ? 'has-error' : ''; ?>">
					<input type="text" name="pay[<?php echo $z; ?>][amount]" value="<?php echo $o->amount; ?>" class="pamount form-control" placeholder="Amount (RM)"/><?php $m += $o->amount ?>
				</div>
			</div>
		</div>
	</div>
								...
								<div class="col-lg-12">
									<div class="row">
										<div class="col-sm-12 col-md-3 col-md-offset-9">
											...
											<div class="col-xs-4 text-right">
												<p>RM<strong id="total_payment"><?php echo $m; ?></strong></p>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-12 col-md-3 col-md-offset-9">
											...
											<div class="col-xs-4 text-right">
												<p>RM<strong id="balance"><?php echo $m - $y; ?></strong></p>
											</div>
										</div>
									</div>
								</div>
